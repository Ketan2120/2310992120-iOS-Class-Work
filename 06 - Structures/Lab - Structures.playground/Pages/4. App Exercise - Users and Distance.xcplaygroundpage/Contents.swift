...
var ketan = User(name: "ketan", age: 20, height: 175.0, weight: 68.0, activityLevel: 4)
print("Name: \(ketan.name), Age: \(ketan.age), Height: \(ketan.height) cm, Weight: \(ketan.weight) kg, Activity Level: \(ketan.activityLevel)")
/*:
